...
function printlabel(lebelObj :{label :string}){
...
printLabelX({name: "james"});// Ok, `name` matched by index signature
...
//Case 2b
printLabelY2({name: "james"});// Ok, `name` matched by index signature
